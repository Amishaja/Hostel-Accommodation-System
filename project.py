...
class hostel():
    def __init__(self,root):
        ...
        titleLbl=tk.Label(self.root, text="Hostel Accommodation System", bg="brown",fg="white",bd=4,relief="groove",font=("Arial",40,"bold"))
        ...
        rnLbl.grid(row=0,column=0,padx=5,pady=5)
        ...
        nameLbl.grid(row=1,column=0,padx=5,pady=5)
        self.nameIn = tk.Entry(inFrame,bd=2,width=20,font=("Arial",15,"bold"))
        self.nameIn.grid(row=1,column=1,padx=5,pady=5)
        ...
        self.classIn.grid(row=2,column=1,padx=5,pady=5)

        fnameLbl = tk.Label(inFrame,bg="light green",font=("Arial",15),text="Father:")
        fnameLbl.grid(row=3,column=0,padx=5,pady=5)
        self.fnameIn=tk.Entry(inFrame,bd=2,width=20,font=("Arial",15,"bold"))
        self.fnameIn.grid(row=3,column=1,padx=5,pady=5)

        okBtn = tk.Button(inFrame, command=self.reserveFun,bd=3,relief="raised",text="OK", font=("Arial",20,"bold"), width=20)
...
# output frame
    ...
    def tabFun(self):
        tabFrame = tk.Frame(self.outFrame, bg="skyblue", bd=3,relief="sunken")
    ...
    def reserveFun(self):
        ...
        con = pymysql.connect(host="localhost",user="root",passwd="pass@word1",database="rec")
        cur = con.cursor()
